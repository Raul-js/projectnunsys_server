...
import es.projectnunsys.repository.FacturaRepository;
import es.projectnunsys.service.criteria.FacturaCriteria;
import es.projectnunsys.service.dto.FacturaDTO;
import es.projectnunsys.service.mapper.FacturaMapper;
...
class FacturaResourceIT {
    ...
    @Test
    @Transactional
    void getAllFacturasByUsuarioIsEqualToSomething() throws Exception {
        // Initialize the database
        facturaRepository.saveAndFlush(factura);
        ...
        // Get all the facturaList where usuario equals to usuarioId
        defaultFacturaShouldBeFound("usuarioId.equals=" + usuarioId);

        // Get all the facturaList where usuario equals to (usuarioId + 1)
        defaultFacturaShouldNotBeFound("usuarioId.equals=" + (usuarioId + 1));
    }
