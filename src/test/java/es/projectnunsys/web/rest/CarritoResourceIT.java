...
class CarritoResourceIT {
    ...
    @Test
    @Transactional
    void getAllCarritosByUsuarioIsEqualToSomething() throws Exception {
        // Initialize the database
        carritoRepository.saveAndFlush(carrito);
        ...
        // Get all the carritoList where usuario equals to usuarioId
        defaultCarritoShouldBeFound("usuarioId.equals=" + usuarioId);

        // Get all the carritoList where usuario equals to (usuarioId + 1)
        defaultCarritoShouldNotBeFound("usuarioId.equals=" + (usuarioId + 1));
    }
