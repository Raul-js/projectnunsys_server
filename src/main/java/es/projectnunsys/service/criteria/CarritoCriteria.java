...
/**
 * Criteria class for the {@link es.projectnunsys.domain.Carrito} entity. This class is used
 * in {@link es.projectnunsys.web.rest.CarritoResource} to receive all the possible filtering options from
...
public class CarritoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, cantidad, fechaCarrito, usuarioId, productoId);
    }
