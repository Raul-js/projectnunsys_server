...
/**
 * Criteria class for the {@link es.projectnunsys.domain.Compra} entity. This class is used
 * in {@link es.projectnunsys.web.rest.CompraResource} to receive all the possible filtering options from
