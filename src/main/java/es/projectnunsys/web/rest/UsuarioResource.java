...
import es.projectnunsys.service.UsuarioQueryService;
import es.projectnunsys.service.UsuarioService;
...
/**
 * REST controller for managing {@link es.projectnunsys.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
