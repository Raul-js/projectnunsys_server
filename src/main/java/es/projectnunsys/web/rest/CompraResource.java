...
import es.projectnunsys.repository.CompraRepository;
import es.projectnunsys.service.CompraQueryService;
import es.projectnunsys.service.CompraService;
import es.projectnunsys.service.criteria.CompraCriteria;
...
/**
 * REST controller for managing {@link es.projectnunsys.domain.Compra}.
 */
@RestController
@RequestMapping("/api")
public class CompraResource {
    ...
    public ResponseEntity<CompraDTO> updateCompra(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, compraDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CompraDTO> partialUpdateCompra(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, compraDTO.getId().toString())
        );
    }
