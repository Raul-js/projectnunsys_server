...
import es.projectnunsys.service.FacturaQueryService;
import es.projectnunsys.service.FacturaService;
...
/**
 * REST controller for managing {@link es.projectnunsys.domain.Factura}.
 */
@RestController
@RequestMapping("/api")
public class FacturaResource {
    ...
    public ResponseEntity<FacturaDTO> partialUpdateFactura(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, facturaDTO.getId().toString())
        );
    }
