...
import es.projectnunsys.service.CarritoQueryService;
import es.projectnunsys.service.CarritoService;
import es.projectnunsys.service.criteria.CarritoCriteria;
...
/**
 * REST controller for managing {@link es.projectnunsys.domain.Carrito}.
 */
@RestController
@RequestMapping("/api")
public class CarritoResource {
    ...
    public ResponseEntity<CarritoDTO> updateCarrito(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, carritoDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CarritoDTO> partialUpdateCarrito(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, carritoDTO.getId().toString())
        );
    }
